...
isNative:false,
	app_modules: ['ui.router','ui.bootstrap','ngJsonExportExcel','cfp.loadingBar','templates-app','templates-common','angularUtils.directives.dirPagination','login','ngCookies','auth'],
	app_scripts: ['jquery','angular','ngJsonExportExcel','FileSaver','cfp.loadingBar','angular.resource','angular.sanitize','ui.router','angular.cookies','ui.bootstrap.tpls','bootstrap','angular.pagination','templates-app','templates-common', 'login/login_controller'],
